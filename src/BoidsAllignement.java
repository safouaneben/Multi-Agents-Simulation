public class BoidsAllignement extends Boids {
    
    public BoidsAllignement(int nbrBoids, int distance, float angleVision )
    {
    ...
    public void traitement1()
    {
        ...
        for (int i = 0; i < boids.length; i++) 
        {
            ...
            acceleration[0]= boids[i].alignement(this,seuilvois,anglevision)[0] ;
            acceleration[1]= boids[i].alignement(this,seuilvois,anglevision)[1] ;
